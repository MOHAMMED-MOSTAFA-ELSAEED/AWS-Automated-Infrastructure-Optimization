...
Purge and delete objects inside the S3 Bucket.

Terminate the EC2 Instance.

Detach and remove the IAM Role Profile.

Delete the custom VPC (automatically cascades tear-down across attached Subnets, IGW, and Route Tables).
